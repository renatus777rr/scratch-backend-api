...
6. after this, create users projects studios. (for projects and studios need user that already in database)
7. i think you understand now, run npm run start
8. alr in scratch-www, webpack-config. we need change in define plugin process.env.API_HOST. 
